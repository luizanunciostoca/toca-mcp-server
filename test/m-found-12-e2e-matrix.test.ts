...
describe('M-FOUND-12 preparation matrix', () => {
  it('keeps the full future governed pipeline explicit', () => {
  ...
  it('covers every required scenario dimension exactly once in the preparation matrix', () => {
...
describe('M-FOUND-12 network-free fake provider', () => {
  it('rejects endpoint or credential injection so preparation cannot invent connectivity', () => {
