...
describe('WhatsAppCloudAdapter', () => {
  it('sends a text payload through the canonical Meta client and preserves provider id', async () => {
  ...
  it('validates only an approved template with the expected variable count', async () => {
