...
requireIncludes('test/creative-truth-openai-image-generator.test.ts', [
  ...
  'rejects reference bytes that do not equal the source SHA pinned in the canonical venue registry',
  'rejects a reference whose Drive identity differs from the canonical venue source',
