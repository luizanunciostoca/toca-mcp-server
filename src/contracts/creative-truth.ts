...
export const creativeTruthFailureCodeSchema = z.enum([
  ...
  'FAILED_QUALITY_GATE',
  'FAILED_TEMPLATE_NOT_RESOLVED',
  'FAILED_TEMPLATE_GEOMETRY_INVALID',
  'FAILED_TEMPLATE_ANALYSIS_MISSING',
  'FAILED_TEMPLATE_REFERENCE_MISMATCH',
  'FAILED_TEMPLATE_FOOTER_MISMATCH',
  'FAILED_TEMPLATE_BACKGROUND_MISMATCH',
  'FAILED_TEMPLATE_SAFE_REGION_INVALID',
  'FAILED_TEMPLATE_CONTRAST_MISMATCH',
  'FAILED_TEMPLATE_ELEMENT_OVERLAP',
  'FAILED_TEMPLATE_PROTECTED_REGION_INVALID',
  'FAILED_TEMPLATE_REQUIRED_ELEMENT_MISSING',
  'FAILED_TEMPLATE_ELEMENT_NOT_ALLOWED',
  'FAILED_TEMPLATE_FONT_ROLE_MISMATCH',
  'FAILED_TEMPLATE_LIBRARY_MIRROR_MISMATCH',
