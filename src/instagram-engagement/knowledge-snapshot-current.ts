...
export const INSTAGRAM_ENGAGEMENT_CURRENT_KNOWLEDGE: readonly InstagramEngagementKnowledgeSnapshotRow[] = [
  ...
  },
  {
    ...
    source:
      'TOCA_OS — 08_OPERACOES — HOMOLOGACAO_E_PARAMETROS_OPERACIONAIS_v1.1 — Drive ID 1Sr4jKNvWZQSlAr3g7klkw_Eou3yLESrcOv2Ednjk7g4 — DEC-02',
    factsToValidate: 'Se houver evento especial ou alteração excepcional, validar EVENTOS_READINESS vigente.',
    sourceUpdatedOn: '2026-08-28',
    status: 'APROVADO',
    operationalValidity: 'ATIVO_ATE_SUBSTITUICAO_CANONICA',
  },
  {
    ...
    source:
      'TOCA_OS — 08_OPERACOES — HOMOLOGACAO_E_PARAMETROS_OPERACIONAIS_v1.1 — Drive ID 1Sr4jKNvWZQSlAr3g7klkw_Eou3yLESrcOv2Ednjk7g4 — DEC-02',
    factsToValidate: 'Nunca inventar nem reutilizar preço antigo; direcionar para canal oficial vigente.',
    sourceUpdatedOn: '2026-08-28',
    status: 'APROVADO',
    operationalValidity: 'ATIVO_ATE_SUBSTITUICAO_CANONICA',
  },
  ...
  },
  {
    ...
    variants: ['Tem site?', 'Qual o site da Toca?', 'Onde vejo informações oficiais?', 'Site oficial?'],
  ...
  },
  {
    ...
    variants: ['Qual o insta da Toca?', 'Instagram da Toca?', 'Qual perfil oficial?', 'Qual o @ da Toca?'],
  ...
  },
  {
    ...
    variants: ['Tem WhatsApp?', 'Qual o número da Toca?', 'Como falo com atendimento?', 'Contato da Toca?'],
    intent: 'FAQ_OPERATIONAL',
    risk: 'LOW',
    autonomy: 'AUTO_REPLY_ALLOWED',
    ...
    factsToValidate: 'Se houver atualização posterior do contato oficial, a fonte mais recente prevalece.',
    sourceUpdatedOn: '2026-08-28',
    status: 'APROVADO',
    operationalValidity: 'ATIVO_ATE_SUBSTITUICAO_CANONICA',
  },
  {
    ...
    factsToValidate: 'Não inventar referência de praia, distância ou rota sem fonte atual específica.',
    sourceUpdatedOn: '2026-08-28',
    status: 'APROVADO',
    operationalValidity: 'ATIVO_ATE_SUBSTITUICAO_CANONICA',
  },
  {
    ...
    factsToValidate: 'Para citar valor exato, consultar a versão visual canônica vigente no momento do atendimento.',
    sourceUpdatedOn: '2026-08-28',
    status: 'APROVADO',
    operationalValidity: 'ATIVO_ATE_SUBSTITUICAO_CANONICA',
  },
