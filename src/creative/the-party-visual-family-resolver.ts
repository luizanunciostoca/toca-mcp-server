...
export const THE_PARTY_HYBRID_MINIMALIST_STANDARD_ID = 'THE_PARTY_HYBRID_MINIMALIST_V1' as const;
...
export type ThePartyVisualStandardId =
  typeof THE_PARTY_HYBRID_NETWORKS_STANDARD_ID | typeof THE_PARTY_HYBRID_MINIMALIST_STANDARD_ID;
