import { TOCA_PHOTO_TO_VIDEO_POLICY_ID, type PhotoToVideoRouteType } from '../../contracts/photo-to-video.js';
...
const SOURCE_ANCHORED_SCENE_CONTINUATION =
...
export class GoogleSheetsPhotoToVideoParentPolicyGuard implements PhotoToVideoParentPolicyGuard {
  constructor(
    ...
    private readonly spreadsheetId = PHOTO_TO_VIDEO_CREATIVE_TRUTH_REGISTRY_ID,
  ) {}
