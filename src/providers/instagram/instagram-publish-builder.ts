...
export function buildInstagramContainerPlan(
  request: InstagramPublishRequest,
): InstagramContainerCreate {
  ...
  switch (request.mediaType) {
    case 'IMAGE':
      ...
      return {
        path,
        body: { image_url: request.mediaUrls[0]!, ...optionalCaption(request.caption) },
      };
    case 'REEL':
    ...
    case 'CAROUSEL': {
      ...
      return {
        ...
        body: {
          media_type: 'CAROUSEL',
          children: '__RESOLVE_CHILD_IDS__',
          ...optionalCaption(request.caption),
        },
        children,
      };
