...
export const MEASUREMENT_CAPABILITY_CONTRACTS: readonly MeasurementCapabilityContract[] = [
  capability(
    ...
    'INTERNAL',
    false,
    'Persist a governed measurement plan.',
  ),
  capability(
    'measurement.plan.validate',
    'R18',
    'READ',
    'INTERNAL',
    false,
    'Validate a measurement plan contract.',
  ),
  capability(
    'tracking.utm.normalize',
    'R18',
    'READ',
    'INTERNAL',
    false,
    'Normalize UTM/source/medium/campaign/content/term dimensions.',
  ),
  capability(
    'measurement.event.normalize',
    'R18',
    'READ',
    'INTERNAL',
    false,
    'Normalize provider measurement events into the canonical schema.',
  ),
  capability(
    ...
    'INTERNAL',
    false,
    'Persist an append-only normalized measurement event.',
  ),
  capability(
    'measurement.data_quality.validate',
    'R18',
    'READ',
    'INTERNAL',
    false,
    'Validate lineage, timestamps and attribution dimensions.',
  ),
  capability(
    'ticketing.event.identity.read',
    'R18',
    'READ',
    'PROVIDER_READ_ONLY_ADAPTER',
    true,
    'Resolve provider ticketing event identity and bind it to EventRecord.',
  ),
  capability(
    ...
    'PROVIDER_READ_ONLY_ADAPTER',
    true,
    'Read and normalize ticketing sales summary.',
  ),
  capability(
    ...
    'PROVIDER_READ_ONLY_ADAPTER',
    true,
    'Read and normalize ticket inventory.',
  ),
  capability(
    ...
    'INTERNAL',
    true,
    'Record normalized provider webhook delivery without provider mutation.',
  ),
  capability(
    ...
    'INTERNAL',
    true,
    'Persist measurement-to-ticket conversion reconciliation.',
  ),
  capability(
    'performance.funnel.calculate',
    'R31',
    'READ',
    'INTERNAL',
    false,
    'Calculate visit-to-checkout-to-ticket funnel.',
  ),
  capability(
    'performance.funnel.dropoff.calculate',
    'R31',
    'READ',
    'INTERNAL',
    false,
    'Calculate stage drop-off.',
  ),
  capability(
    'performance.attribution.calculate',
    'R31',
    'READ',
    'INTERNAL',
    false,
  ...
  capability(
    'performance.attribution.confidence.calculate',
    'R31',
    'READ',
    'INTERNAL',
    false,
    'Calculate attribution confidence from source quality and identity continuity.',
  ),
  capability(
    'performance.event.sales_pacing.calculate',
    'R31',
    'READ',
    'INTERNAL',
    true,
    'Calculate event ticket sales pacing against EventRecord timing.',
  ),
] as const;
