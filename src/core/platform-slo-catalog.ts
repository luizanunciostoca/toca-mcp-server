...
export const PLATFORM_SLO_IDS = [
  ...
  'autopilot_shadow_agreement',
  'approval_response_latency',
  'scheduler_execution_lag',
  'provider_error_rate',
...
export const PLATFORM_NEXT_SLOS: readonly PlatformSloDefinition[] = Object.freeze([
  ...
  {
    id: 'autopilot_shadow_agreement',
    routeId: 'R25',
    signal: 'autopilot.shadow_exact_agreement_ratio',
    kind: 'RATIO',
    comparator: 'GTE',
    target: 1,
    windowMinutes: 1440,
    severity: 'P1',
    futureProvider: false,
    runbook: 'docs/operations/observability-incident-runbook.md#autopilot-rollout',
  },
  {
    id: 'approval_response_latency',
    routeId: 'R25',
    signal: 'approval.response_p95_seconds',
    kind: 'LATENCY_SECONDS',
    comparator: 'LTE',
    target: 900,
    windowMinutes: 1440,
    severity: 'P2',
    futureProvider: false,
    runbook: 'docs/operations/observability-incident-runbook.md#approval',
  },
  {
    id: 'scheduler_execution_lag',
    routeId: 'R25',
    signal: 'scheduler.publication_lag_p95_seconds',
    kind: 'LAG_SECONDS',
    comparator: 'LTE',
    target: 300,
    windowMinutes: 60,
    severity: 'P1',
    futureProvider: false,
    runbook: 'docs/operations/observability-incident-runbook.md#scheduler-watchdog',
  },
  {
    id: 'provider_error_rate',
    routeId: 'R25',
    signal: 'provider.external_error_ratio',
    kind: 'RATIO',
    comparator: 'LTE',
    target: 0.01,
    windowMinutes: 60,
  ...
  },
  {
    ...
    routeId: 'R25',
    signal: 'autopilot.human_intervention_ratio',
    kind: 'RATIO',
    comparator: 'LTE',
    target: 0.25,
    windowMinutes: 1440,
  ...
  {
    id: 'recommendation_adoption_rate',
    routeId: 'R31',
    signal: 'r31.recommendation_adoption_ratio',
    kind: 'RATIO',
    comparator: 'GTE',
    target: 0.1,
    windowMinutes: 10080,
